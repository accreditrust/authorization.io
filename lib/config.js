...
config.views.less.compile.out = path.join(cacheDir, 'app.css');
config.views.css.optimize.out = path.join(cacheDir, 'app.min.css');
config.views.angular.optimize.templates.out =
  path.join(cacheDir, 'angular-templates.js');
config.requirejs.optimize.config.out = path.join(cacheDir, 'main.min.js');
